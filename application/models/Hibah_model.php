...
class Hibah_model extends MY_Model
{
    ...
    public function get_total_rincian($id_hibah = NULL)
    {
        ...
        $qa = "SELECT SUM(nilai) AS nilai FROM temp_aset_a WHERE id_hibah = {$id_hibah} AND id_hapus IS NULL AND id_koreksi IS NULL";
        $qb = "SELECT SUM(nilai) AS nilai FROM temp_aset_b WHERE id_hibah = {$id_hibah} AND id_hapus IS NULL AND id_koreksi IS NULL";
        $qc = "SELECT SUM(nilai) AS nilai FROM temp_aset_c WHERE id_hibah = {$id_hibah} AND id_hapus IS NULL AND id_koreksi IS NULL";
        $qd = "SELECT SUM(nilai) AS nilai FROM temp_aset_d WHERE id_hibah = {$id_hibah} AND id_hapus IS NULL AND id_koreksi IS NULL";
        $qe = "SELECT SUM(nilai) AS nilai FROM temp_aset_e WHERE id_hibah = {$id_hibah} AND id_hapus IS NULL AND id_koreksi IS NULL";
        $qg = "SELECT SUM(nilai) AS nilai FROM temp_aset_g WHERE id_hibah = {$id_hibah} AND id_hapus IS NULL AND id_koreksi IS NULL";
