...
class Saldo_kibg_model extends MY_Model_aset
{
	public $_table = 'saldo_aset_g';
    public $_kolom = array('tgl_perolehan', 'tgl_pembukuan', 'merk', 'tipe', 'ukuran', 'asal_usul', 'kondisi', 'nilai');
