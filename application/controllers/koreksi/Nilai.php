...
class Nilai extends MY_Controller {
    ...
    public function rincian($id = NULL)
    {
        ...
        $this->render('modules/koreksi/nilai/rincian', $data);
    }
    ...
    public function rincian_redirect()
    {
        ...
        switch ($jenis) {
            case 'a':
            $this->go('koreksi/aset/kiba/koreksi_nilai/'.$id);
            break;
            case 'b':
            $this->go('koreksi/aset/kibb/koreksi_nilai/'.$id);
            break;
            case 'c':
            $this->go('koreksi/aset/kibc/koreksi_nilai/'.$id);
            break;
            case 'd':
            $this->go('koreksi/aset/kibd/koreksi_nilai/'.$id);
            break;
            case 'e':
    ...
    public function insert()
    {
        ...
        if($sukses) {
            ...
            $this->go('koreksi/nilai/rincian/'.$sukses);
        } else {
    ...
    public function update()
    {
        ...
        if (!$this->koreksi->form_verify($data)) {
            $this->message('Isi data yang perlu diisi.', 'warning');
            $this->go('koreksi/nilai/rincian/'.$id);
        }
    ...
    public function delete($id_koreksi = null)
    {
        ...
        if ($koreksi->status_pengajuan == 1 OR $koreksi->status_pengajuan == 2) {
            ...
            $this->go('koreksi/nilai?id_organisasi='.$koreksi->id_organisasi);
            die();
        }
    ...
    public function abort_transaction($id_koreksi = NULL)
    {
        # JIKA KOSONG
        if (empty($id_koreksi)) {
            $this->message('Pilih data koreksi nilai yang akan dibatalkan', 'danger');
            $this->go('koreksi/nilai/');
        }
        ...
        foreach ($alfabet as $item) {
            ...
            foreach ($temp as $aset) {
                ...
                $this->{$model_kib}->update($aset->id_aset, array('nilai'=>$orginal_value));
            }
        }
