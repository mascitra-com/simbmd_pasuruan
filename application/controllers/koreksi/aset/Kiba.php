...
class Kiba extends MY_Controller
{
    ...
    public function insert_kepemilikan()
    {
        ...
        if($sukses) {
            ...
            if($sukses2) {
                $this->message('Data berhasil ditambah','success');
                $this->go('koreksi/aset/kiba/koreksi_kepemilikan/'.$id_koreksi);
            } else {
                # ROLL OUT
    ...
    public function insert_kode()
    {
        ...
        if($sukses) {
            ...
            if($sukses2) {
                $this->message('Data berhasil ditambah','success');
                $this->go('koreksi/aset/kiba/koreksi_kode/'.$id_koreksi);
            } else {
                # ROLL OUT
                $this->koreksi_detail->delete($sukses);
    ...
    public function insert_hapus()
    {
        ...
        if($sukses) {
            $this->message('Data berhasil ditambah','success');
            $this->go('koreksi/aset/kiba/koreksi_hapus/'.$id_koreksi);
        } else {
                # ROLL OUT
            $this->koreksi_detail->delete($sukses);
