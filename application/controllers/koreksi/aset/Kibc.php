...
class Kibc extends MY_Controller
{
    ...
    public function koreksi_nilai($id_koreksi = NULL)
    {
        ...
        $data['pagination']     = $this->pagination->get_pagination($result['data_count'], $filter, 'koreksi/aset/kibc/koreksi_nilai/'.$id_koreksi);

        $this->render('modules/koreksi/nilai/kibc', $data);
    }
    ...
    public function insert_nilai()
    {
        ...
        if($sukses) {
            ...
            if($sukses2) {
                ...
                $this->go('koreksi/aset/kibc/koreksi_nilai/'.$id_koreksi);
            } else {
                # ROLL OUT
    ...
    public function koreksi_kepemilikan($id_koreksi = NULL)
    {
        ...
        # PENTING!!!
        // $where_not_in = $this->kib_temp->select('id_aset')->join('koreksi','temp_aset_c.id_koreksi=koreksi.id')->or_where(array('id_koreksi'=>$id_koreksi, 'status_pengajuan<>'=>2))->as_array()->get_all();
        $where_not_in = $this->kib_temp->select('id_aset')->join('koreksi','temp_aset_c.id_koreksi=koreksi.id')->where(array('id_koreksi'=>$id_koreksi))->as_array()->get_all();
        $where_not_in = array_column($where_not_in, 'id_aset');
        ...
        $data['pagination']     = $this->pagination->get_pagination($result['data_count'], $filter, 'koreksi/aset/kibc/koreksi_kepemilikan/'.$id_koreksi);

        $this->render('modules/koreksi/kepemilikan/kibc', $data);
    }
    ...
    public function insert_kepemilikan()
    {
        ...
        if($sukses) {
            ...
            if($sukses2) {
                $this->message('Data berhasil ditambah','success');
                $this->go('koreksi/aset/kibc/koreksi_kepemilikan/'.$id_koreksi);
            } else {
                # ROLL OUT
    ...
    public function koreksi_kode($id_koreksi = NULL)
    {
        ...
        $data['pagination']     = $this->pagination->get_pagination($result['data_count'], $filter, 'koreksi/aset/kibc/koreksi_kode/'.$id_koreksi);

        $this->render('modules/koreksi/kode/kibc', $data);
    }
    ...
    public function insert_kode()
    {
        ...
        if($sukses) {
            ...
            if($sukses2) {
                $this->message('Data berhasil ditambah','success');
                $this->go('koreksi/aset/kibc/koreksi_kode/'.$id_koreksi);
            } else {
                # ROLL OUT
                $this->koreksi_detail->delete($sukses);
    ...
    public function koreksi_hapus($id_koreksi = NULL)
    {
        ...
        $data['kib']            = $result['data'];
        $data['terpilih_count'] = count($where_not_in);
        $data['pagination']     = $this->pagination->get_pagination($result['data_count'], $filter, 'koreksi/aset/kibc/koreksi_hapus/'.$id_koreksi);

        $this->render('modules/koreksi/hapus/kibc', $data);
    }
    ...
    public function insert_hapus()
    {
        ...
        if($sukses) {
            $this->message('Data berhasil ditambah','success');
            $this->go('koreksi/aset/kibc/koreksi_hapus/'.$id_koreksi);
        } else {
                # ROLL OUT
            $this->koreksi_detail->delete($sukses);
