...
class Kibe extends MY_Controller
{
    ...
    public function koreksi_nilai($id_koreksi = NULL)
    {
        ...
        $data['pagination']     = $this->pagination->get_pagination($result['data_count'], $filter, 'koreksi/aset/kibe/koreksi_nilai/'.$id_koreksi);
    ...
    public function koreksi_kepemilikan($id_koreksi = NULL)
    {
        ...
        $data['pagination']     = $this->pagination->get_pagination($result['data_count'], $filter, 'koreksi/aset/kibe/koreksi_kepemilikan/'.$id_koreksi);
    ...
    public function koreksi_kode($id_koreksi = NULL)
    {
        ...
        $data['pagination']     = $this->pagination->get_pagination($result['data_count'], $filter, 'koreksi/aset/kibe/koreksi_kode/'.$id_koreksi);
    ...
    public function koreksi_hapus($id_koreksi = NULL)
    {
        ...
        $data['kib']            = $result['data'];
        $data['terpilih_count'] = count($where_not_in);
        $data['pagination']     = $this->pagination->get_pagination($result['data_count'], $filter, 'koreksi/aset/kibe/koreksi_hapus/'.$id_koreksi);
