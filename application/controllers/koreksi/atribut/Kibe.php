...
class Kibe extends MY_Controller
{
	...
	public function index($id_koreksi = null)
	{
		...
		$this->render('modules/koreksi/atribut/kibe', $data);
	}
	...
	private function finalize_data($data, $is_rincian = FALSE)
	{
		foreach ($data['rows'] as $key => $value) {
			...
			if (!$is_rincian) {
				...
				$value['aksi'] = "<a href='".site_url('koreksi/atribut/kibe/delete/'.$value['id'])."' class='btn btn-sm btn-danger btn-block'><i class='fa fa-times'></i></a>";
			}
	...
	public function insert()
	{
		...
		$this->go('koreksi/atribut/kibe/index/'.$id_koreksi);
	}
