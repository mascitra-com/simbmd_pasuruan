...
class Kibc extends MY_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('aset/inventarisasi/Kibc_model', 'kib');
    ...
    public function index()
    {
        ...
        $this->render('modules/aset/inventarisasi/kibc/index', $data);
    }
    ...
    public function kdp()
    {
        ...
        $this->render('modules/aset/inventarisasi/kibc/kdp', $data);
    }
    ...
    public function insert()
    {
        ...
        if (!$this->kib->form_verify($data)) {
            ...
            $this->go('aset/inventarisasi/kibc/add/' . $data['id_organisasi']);
        }
    ...
    public function update()
    {
        ...
        if (!$this->kib->form_verify($data)) {
            $this->message('Isi data yang wajib diisi', 'danger');
            $this->go('aset/inventarisasi/kibc/edit/' . $id);
        }

        $sukses = $this->kib->update($id, $data);
        if ($sukses) {
            $this->message('Data berhasil disimpan', 'success');
            $this->go('aset/inventarisasi/kibc?id_organisasi='.$data['id_organisasi']);
        } else {
            $this->message('Data gagal disimpan', 'danger');
            $this->go('aset/inventarisasi/kibc/edit/' . $id);
        }
    ...
    public function delete($id = NULL)
    {
        ...
        if ($sukses) {
            $this->message("Data berhasil dihapus, <a href='" . site_url('aset/inventarisasi/kibc/undelete/' . $id) . "'><b>Urungkan!</b></a>", 'success');
            $this->go('aset/inventarisasi/kibc');
        } else {
