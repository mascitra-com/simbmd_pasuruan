...
class Kibb extends MY_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('aset/inventarisasi/Kibb_model', 'kib');
    ...
    public function index()
    {
        ...
        $this->render('modules/aset/inventarisasi/kibb/index', $data);
    }
    ...
    public function add($id = NULL)
    {
        if (empty($id)) {
            ...
            $this->go('aset/inventarisasi/kibb');
        }
        ...
        $this->render('modules/aset/inventarisasi/kibb/form', $data);
    }
    ...
    public function insert()
    {
        ...
        if (!$this->kib->form_verify($data)) {
            ...
            $this->go('aset/inventarisasi/kibb/add/' . $data['id_organisasi']);
        }
    ...
    public function update()
    {
        ...
        if (!$this->kib->form_verify($data)) {
            $this->message('Isi data yang wajib diisi', 'danger');
            $this->go('aset/inventarisasi/kibb/edit/' . $id);
        }

        $sukses = $this->kib->update($id, $data);
        if ($sukses) {
            $this->message('Data berhasil disimpan', 'success');
            $this->go('aset/inventarisasi/kibb?id_organisasi='.$data['id_organisasi']);
        } else {
            $this->message('Data gagal disimpan', 'danger');
            $this->go('aset/inventarisasi/kibb/edit/' . $id);
        }
    ...
    public function delete($id = NULL)
    {
        ...
        if ($sukses) {
            $this->message("Data berhasil dihapus, <a href='" . site_url('aset/inventarisasi/kibb/undelete/' . $id) . "'><b>Urungkan!</b></a>", 'success');
            $this->go('aset/inventarisasi/kibb');
        } else {
