...
class Kibe extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->render('modules/aset/inventarisasi/kibe/index', $data);
    }
    ...
    public function add($id = NULL)
    {
        if (empty($id)) {
            ...
            $this->go('aset/inventarisasi/kibe');
        }
        ...
        $this->render('modules/aset/inventarisasi/kibe/form', $data);
    }
    ...
    public function insert()
    {
        ...
        if (!$this->kib->form_verify($data)) {
            ...
            $this->go('aset/inventarisasi/kibe/add/' . $data['id_organisasi']);
        }
    ...
    public function update()
    {
        ...
        if (!$this->kib->form_verify($data)) {
            $this->message('Isi data yang wajib diisi', 'danger');
            $this->go('aset/inventarisasi/kibe/edit/' . $id);
        }
    ...
    public function delete($id = NULL)
    {
        ...
        if ($sukses) {
            $this->message("Data berhasil dihapus, <a href='" . site_url('aset/inventarisasi/kibe/undelete/' . $id) . "'><b>Urungkan!</b></a>", 'success');
            $this->go('aset/inventarisasi/kibe');
        } else {
