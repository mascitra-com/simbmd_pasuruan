...
class Kiba extends MY_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('aset/inventarisasi/Kiba_model', 'kib');
    ...
    public function index()
    {
        ...
        $this->render('modules/aset/inventarisasi/kiba/index', $data);
    }
    ...
    public function insert()
    {
        ...
        if (!$this->kib->form_verify($data)) {
            ...
            $this->go('aset/inventarisasi/kiba/add/' . $data['id_organisasi']);
        }
    ...
    public function update()
    {
        ...
        if (!$this->kib->form_verify($data)) {
            $this->message('Isi data yang wajib diisi', 'danger');
            $this->go('aset/inventarisasi/kiba/edit/' . $id);
        }

        $sukses = $this->kib->update($id, $data);
        if ($sukses) {
            $this->message('Data berhasil disimpan', 'success');
            $this->go('aset/inventarisasi/kiba?id_organisasi=' . $data['id_organisasi']);
    ...
    public function delete($id = NULL)
    {
        ...
        if ($sukses) {
            $this->message("Data berhasil dihapus, <a href='" . site_url('aset/inventarisasi/kiba/undelete/' . $id) . "'><b>Urungkan!</b></a>", 'success');
            $this->go('aset/inventarisasi/kiba');
        } else {
