...
class Kibe extends MY_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('aset/Saldo_kibe_model', 'kib_saldo');
        $this->load->model('aset/Kibe_model', 'kib_berjalan');
    ...
    public function update()
    {
        ...
        $this->go('aset/kibe?source=berjalan&id_organisasi='.$id_organisasi);
    }
}