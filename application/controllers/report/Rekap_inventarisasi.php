...
class Rekap_inventarisasi extends MY_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('report/Rekap_inventarisasi_model', 'report');
	...
	public function index()
	{
		...
		$this->render('modules/report/rekap_inventarisasi/index', $data);
	}
	...
	public function cetak()
	{
		...
		$data['detail'] = $input;
		$data['rekap']  = $this->report->report($data['detail']);

		$this->render('modules/report/rekap_inventarisasi/cetak', $data);
	}
}