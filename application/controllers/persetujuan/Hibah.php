		...
		foreach ($alfabet as $item) {
			...
			if (!empty($data)) {
				foreach ($data as $key => $value)
				{
					...
					unset($value->id, $value->id_aset, $value->id_spk, $value->id_sp2d, $value->id_hapus, $value->id_transfer, $value->id_koreksi, $value->id_koreksi_detail, $value->id_inventarisasi);
				}
