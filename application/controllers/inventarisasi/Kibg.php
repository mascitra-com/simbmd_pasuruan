...
class Kibg extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->render('modules/aset/saldo_berjalan/kibg/index', $data);
    }
    ...
    public function add($id = NULL)
    {
        ...
        $this->render('modules/aset/saldo_berjalan/kibg/form', $data);
    }
    ...
    public function insert()
    {
        ...
        if (!$this->kib->form_verify($data)) {
            ...
            $this->go('inventarisasi/kibg/add/' . $data['id_organisasi']);
        }
