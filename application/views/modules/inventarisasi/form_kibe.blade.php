...
@section('title')Inventarisasi - Tambah Aset@end
...
<div class="row">
	<div class="col">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{isset($kib)?site_url('inventarisasi/kibe/update'):site_url('inventarisasi/kibe/insert')}}" method="POST">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							<select class="form-control" name="asal_usul">
								...
								<option value="Inventarisasi" {{isset($kib) && $kib->asal_usul == 'inventarisasi'?'selected':''}}>Inventarisasi</option>
							</select>
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							...
							<a href="{{site_url('inventarisasi/index/rincian/'.$inventarisasi->id)}}" class="btn btn-warning">Kembali</a>
						</div>
					</div>
				</form>
			</div>
