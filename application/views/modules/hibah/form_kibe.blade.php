...
<div class="row">
	<div class="col">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{isset($kib)?site_url('hibah/kibe/update'):site_url('hibah/kibe/insert')}}" method="POST">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							<input type="text" class="form-control" value="{{zerofy($hapus->id, 5)}}" disabled />
						</div>
					</div>
					<div class="form-group row">
