...
<div class="form-inline">
    <div class="btn-group mb-3">
        ...
        <a href="{{site_url('hibah/index/rincian/'.$hibah->id)}}{{$ref?'?ref=true':''}}" class="btn btn-primary">02. Rincian Aset</a>
    </div>
    @if(!$ref)
...
<script>
    ...
    @if($hibah->status_pengajuan === '1' OR $hibah->status_pengajuan === '2' OR $ref)
