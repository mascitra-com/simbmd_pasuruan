...
<div class="row">
	<div class="col">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{isset($kib)?site_url('hibah/kibb/update'):site_url('hibah/kibb/insert')}}" method="POST">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							<input type="text" class="form-control" value="{{zerofy($hibah->id)}}" disabled />
						</div>
					</div>
					<div class="form-group row">
