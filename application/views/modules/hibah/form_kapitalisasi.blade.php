				...
				<form action="{{isset($kpt) ? site_url('hibah/kapitalisasi/update') : site_url('hibah/kapitalisasi/insert')}}" method="POST">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							...
							<a href="{{site_url('hibah/index/rincian/'.$hibah->id)}}" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Kembali</a>
						</div>
					</div>
				</form>
			</div>
...
<script type="text/javascript">
	...
	$(".btn-aset").on('click', function(e){
		...
		var url = 'hibah/'+kib+'/get?id_organisasi={{$hibah->id_organisasi}}&id_kategori='+idKategori;
