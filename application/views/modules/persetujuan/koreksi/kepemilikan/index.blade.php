...
<li class="breadcrumb-item active">Persetujuan Koreksi Kepemilikan</li>
@end
				...
				<tbody>
					...
					<tr class="small">
						...
						<td class="text-center">
							<div class="btn-group">
								<a href="{{ site_url('persetujuan/koreksi_kepemilikan/rincian/'.$item->id) }}" class="btn btn-sm btn-primary btn-sm"><i class="fa fa-eye"></i></a>
	...
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content" style="background-color: #28a745; color: #FFF">
			...
			<div class="modal-body">
				<form action="{{site_url('persetujuan/koreksi_kepemilikan/verifikasi')}}" method="POST">
