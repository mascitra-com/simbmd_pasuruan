...
<li class="breadcrumb-item"><a href="{{site_url('persetujuan/koreksi_atribut')}}">Koreksi</a></li>
<li class="breadcrumb-item active">Koreksi Atribut</li>
@end

@section('content')
<div class="card">
	<div class="card-header">Pengajuan Koreksi Atribut</div>
	<div class="card-body">
		<table class="jq-table table-striped" data-search="true" data-search-on-enter-key="true" data-pagination="true" data-side-pagination="server" data-url="{{site_url('persetujuan/koreksi_atribut/get_koreksi')}}">
			<thead>
				<tr>
	...
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content" style="background-color: #28a745; color: #FFF">
			...
			<div class="modal-body">
				<form action="{{site_url('persetujuan/koreksi_atribut/verifikasi')}}" method="POST">
...
<script>
	...
	function setuju(e) {
		...
		$("#modal-setuju [name='id_koreksi']").val(id);
		$("#modal-setuju").modal('show');
	}

	function tolak(e) {
		var id = $(e.currentTarget).data('id');
		$("#modal-tolak [name='id_koreksi']").val(id);
