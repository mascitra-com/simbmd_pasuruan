...
<li class="breadcrumb-item"><a href="#">Sub-Unit</a></li>
<li class="breadcrumb-item"><a href="{{site_url('organisasi/upb/'.$id)}}">UPB</a></li>
...
<div class="card">
	...
	<div class="card-body">
		<form action="{{isset($organisasi)?site_url('organisasi/update?ref=organisasi/upb/'.$id):site_url('organisasi/insert?ref=organisasi/upb/'.$id)}}" method="POST">
			...
			<div class="form-group row">
				...
				<div class="col-md-4 form-row">
					...
					<input type="text" name="kd_subunit" value="{{isset($organisasi)?$organisasi->kd_subunit : $induk->kd_subunit}}" class="form-control text-center col" readonly />
					<input type="text" name="kd_upb" value="{{isset($organisasi)?$organisasi->kd_upb : ''}}" class="form-control text-center col" required />
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-md-4">
					...
					<a href="{{site_url('organisasi/upb/'.$id)}}" class="btn btn-warning">Kembali</a>
				</div>
			</div>
		</form>
	</div>
