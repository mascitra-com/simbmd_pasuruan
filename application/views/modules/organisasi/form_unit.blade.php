...
<li class="breadcrumb-item"><a href="{{site_url('organisasi/unit/'.$id)}}">Unit</a></li>
...
<div class="card">
	...
	<div class="card-body">
		<form action="{{isset($organisasi)?site_url('organisasi/update?ref=organisasi/unit/'.$id):site_url('organisasi/insert?ref=organisasi/unit/'.$id)}}" method="POST">
			...
			<div class="form-group row">
				...
				<div class="col-md-4 form-row">
					...
					<input type="text" name="kd_unit" value="{{isset($organisasi)?$organisasi->kd_unit : ''}}" class="form-control text-center col" required />
					<input type="text" name="kd_subunit" class="form-control text-center col" disabled />
			...
			<div class="form-group row">
				...
				<div class="col-md-4">
					...
					<a href="{{site_url('organisasi/unit/'.$id)}}" class="btn btn-warning">Kembali</a>
				</div>
			</div>
		</form>
	</div>
