...
<div class="form-inline">
    <div class="btn-group mb-3 ml-auto">
        ...
        <a href="{{site_url('koreksi/kepemilikan/finish_transaction/'.$koreksi->id)}}" class="btn btn-success" onclick="return confirm('Anda yakin? Data tidak dapat disunting jika telah diajukan.')"><i class="fa fa-check mr-2"></i>Selesaikan Transaksi</a>
        @elseif($koreksi->status_pengajuan === '1')
        <a href="{{site_url('koreksi/kepemilikan/cancel_transaction/'.$koreksi->id)}}" class="btn btn-warning" onclick="return confirm('Anda yakin?')"><i class="fa fa-check mr-2"></i>Batalkan Pengajuan</a>
        @endif
    </div>
</div>
<div class="row mb-3">
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{site_url('koreksi/kepemilikan/update')}}" method="POST" class="form-row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap text-center">
                                    <a href="{{site_url('koreksi/aset/kiba/delete_kepemilikan/'.$item->id)}}" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin?')"><i class="fa fa-times"></i></a>
                                </td>
                                @endif
                                <td class="text-nowrap text-center">
                    ...
                    <table class="table table-hover table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                @if($koreksi->status_pengajuan === '0' OR $koreksi->status_pengajuan === '3')
                                <td class="text-nowrap text-center">
                                    <a href="{{site_url('koreksi/aset/kibb/delete_kepemilikan/'.$item->id)}}" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin?')"><i class="fa fa-times"></i></a>
                                </td>
                                @endif
                                <td class="text-nowrap text-center">
                                    {{zerofy($item->id_kategori->kd_golongan)}} .
                    ...
                    <table class="table table-hover table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                @if($koreksi->status_pengajuan === '0' OR $koreksi->status_pengajuan === '3')
                                <td class="text-nowrap text-center">
                                    <a href="{{site_url('koreksi/aset/kibc/delete_kepemilikan/'.$item->id)}}" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin?')"><i class="fa fa-times"></i></a>
                                </td>
                                @endif
                                <td class="text-nowrap text-center">
                                    {{zerofy($item->id_kategori->kd_golongan)}} .
                    ...
                    <table class="table table-hover table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                @if($koreksi->status_pengajuan === '0' OR $koreksi->status_pengajuan === '3')
                                <td class="text-nowrap text-center">
                                    <a href="{{site_url('koreksi/aset/kibd/delete_kepemilikan/'.$item->id)}}" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin?')"><i class="fa fa-times"></i></a>
                                </td>
                                @endif
                                <td class="text-nowrap text-center">
                                    {{zerofy($item->id_kategori->kd_golongan)}} .
                    ...
                    <table class="table table-hover table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                @if($koreksi->status_pengajuan === '0' OR $koreksi->status_pengajuan === '3')
                                <td class="text-nowrap text-center">
                                    <a href="{{site_url('koreksi/aset/kibe/delete_kepemilikan/'.$item->id)}}" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin?')"><i class="fa fa-times"></i></a>
                                </td>
                                @endif
                                <td class="text-nowrap text-center">
                                    {{zerofy($item->id_kategori->kd_golongan)}} .
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="{{site_url('koreksi/kepemilikan/rincian_redirect')}}" method="POST">
                        <input type="hidden" name="id" value="{{$koreksi->id}}">
