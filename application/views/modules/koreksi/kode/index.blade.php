...
@section('title')Reklas Kode@end

@section('breadcrump')
<li class="breadcrumb-item"><a href="{{site_url()}}">Beranda</a></li>
<li class="breadcrumb-item"><a href="#">Koreksi</a></li>
<li class="breadcrumb-item active">Reklas Kode</li>
@endsection
				...
				<tbody>
					...
					<tr class="small">
						...
						<td class="text-center">
							<div class="btn-group">
								<a href="{{ site_url('koreksi/koreksi_kode/rincian') }}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> Rincian</a>
							</div>
						</td>
					</tr>
                </tbody>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Tambah Reklas Kode</h4>
