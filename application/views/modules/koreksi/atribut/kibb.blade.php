...
@section('content')
<div class="card">
	<div class="card-header">KIB-B (Peralatan &amp Mesin)</div>
	<div class="card-body">
		<table class="jq-table table-striped" id="tb-kibb" data-search="true" data-show-columns="true" data-search-on-enter-key="true" data-pagination="true" data-side-pagination="server" data-url="{{site_url('koreksi/atribut/kibb/get/'.$koreksi->id)}}">
			<thead>
					<tr>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{site_url('koreksi/atribut/kibb/insert')}}" method="POST">
					...
					<div class="row">
						...
						<div class="form-group col">
							<label for="">No. Pabrik</label>
							<input type="text" class="form-control" name="no_pabrik" placeholder="No. Pabrik">
						</div>
						<div class="form-group col">
					...
					<div class="row">
						...
						<div class="form-group col">
							...
							<input type="text" class="form-control" name="no_bpkb" placeholder="No. BPKB">
						</div>
					</div>
					<div class="row">
						<div class="form-group col">
...
<script>
	...
	$("table > tbody").delegate('[data-id]', 'click', function(e){
		...
		$.getJSON("{{site_url('koreksi/atribut/kibb/get/'.$koreksi->id.'?id=')}}"+id, function(result){
