					...
					<tbody>
						...
						<tr>
							<td class="text-nowrap text-center">
								<a href="{{site_url('koreksi/aset/kibb/insert_hapus?id_aset='.$item->id.'&id_koreksi='.$koreksi->id)}}" class="btn btn-primary"><i class="fa fa-plus"></i></a>
							</td>
							<td class="text-nowrap text-center">
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{site_url('koreksi/aset/kibb/koreksi_hapus/'.$koreksi->id)}}" method="GET">
