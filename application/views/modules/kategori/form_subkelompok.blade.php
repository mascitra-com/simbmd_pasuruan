...
<li class="breadcrumb-item"><a href="{{site_url('kategori/subkelompok/'.$id)}}">Sub Kelompok</a></li>
...
<div class="card">
	...
	<div class="card-body">
		<form action="{{isset($kategori)?site_url('kategori/update?ref=kategori/subkelompok/'.$id):site_url('kategori/insert?ref=kategori/subkelompok/'.$id)}}" method="POST">
			...
			<div class="form-group row">
				...
				<div class="col-md-4 form-row">
					...
					<input type="text" name="kd_subkelompok" value="{{isset($kategori)?$kategori->kd_subkelompok : ''}}" class="form-control text-center col" required />
			...
			<div class="form-group row">
				...
				<div class="col-md-4">
					...
					<a href="{{site_url('kategori/subkelompok/'.$id)}}" class="btn btn-warning">Kembali</a>
				</div>
			</div>
		</form>
	</div>
