...
<li class="breadcrumb-item"><a href="{{site_url('kategori/subkelompok/'.$induk->sub_dari)}}">Sub Kelompok</a></li>
<li class="breadcrumb-item active">Sub Sub-Kelompok</li>
@end
		...
		<div class="card">
			<div class="card-header form-inline">
				...
				<div class="btn-group">
					...
					<a href="{{site_url('kategori/add/5?id='.$induk->id)}}" class="btn btn-primary btn-tambah"><i class="fa fa-plus mr-2"></i>Tambah</a>
				</div>
			</div>
