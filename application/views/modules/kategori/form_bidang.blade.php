...
<li class="breadcrumb-item"><a href="{{site_url('kategori/bidang/'.$id)}}">Bidang</a></li>
...
<div class="card">
	...
	<div class="card-body">
		<form action="{{isset($kategori)?site_url('kategori/update?ref=kategori/bidang/'.$id):site_url('kategori/insert?ref=kategori/bidang/'.$id)}}" method="POST">
			...
			<div class="form-group row">
				...
				<div class="col-md-4 form-row">
					...
					<input type="text" name="kd_bidang" value="{{isset($kategori)?$kategori->kd_bidang : ''}}" class="form-control text-center col" required />
			...
			<div class="form-group row">
				...
				<div class="col-md-4">
					...
					<a href="{{site_url('kategori/bidang/'.$id)}}" class="btn btn-warning">Kembali</a>
				</div>
			</div>
		</form>
	</div>
