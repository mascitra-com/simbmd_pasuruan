...
<li class="breadcrumb-item"><a href="{{site_url('kategori/subsubkelompok/'.$id)}}">Sub Sub-Kelompok</a></li>
...
<div class="card">
	...
	<div class="card-body">
		<form action="{{isset($kategori)?site_url('kategori/update?ref=kategori/subsubkelompok/'.$id):site_url('kategori/insert?ref=kategori/subsubkelompok/'.$id)}}" method="POST">
			...
			<div class="form-group row">
				...
				<div class="col-md-4 form-row">
					...
					<input type="text" name="kd_kelompok" value="{{isset($kategori)?$kategori->kd_kelompok : $induk->kd_kelompok}}" class="form-control text-center col" readonly />
					<input type="text" name="kd_subkelompok" value="{{isset($kategori)?$kategori->kd_subkelompok : $induk->kd_subkelompok}}" class="form-control text-center col" readonly />
					<input type="text" name="kd_subsubkelompok" value="{{isset($kategori)?$kategori->kd_subsubkelompok : ''}}" class="form-control text-center col" required />
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-md-4">
					...
					<a href="{{site_url('kategori/subsubkelompok/'.$id)}}" class="btn btn-warning">Kembali</a>
				</div>
			</div>
		</form>
	</div>
