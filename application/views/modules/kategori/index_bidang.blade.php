		...
		<div class="card">
			<div class="card-header form-inline">
				...
				<div class="btn-group">
					...
					<a href="{{site_url('kategori/add/2?id='.$induk->id)}}" class="btn btn-primary btn-tambah"><i class="fa fa-plus mr-2"></i>Tambah</a>
				</div>
			</div>
						...
						<tr>
							...
							<td>
								<div class="btn-group btn-group-sm">
									<a href="{{site_url('kategori/kelompok/'.$kat->id)}}" class="btn btn-success"><i class="fa fa-eye"></i> Lihat Sub</a>
