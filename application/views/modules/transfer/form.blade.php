...
<div class="row">
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{site_url('transfer/index/insert')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <hr>
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label text-right" for="">Unggah berkas penunjang</label><br>
                        <div class="col-md-4">
