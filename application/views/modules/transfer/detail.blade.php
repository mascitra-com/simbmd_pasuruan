...
@section('title')Transfer {{$ref==='masuk'?'Masuk':'Keluar'}}@end
...
<div class="form-inline">
    <div class="btn-group mb-3">
        <a href="#" class="btn btn-primary active">01. Detail Transfer {{$ref==='masuk'?'Masuk':'Keluar'}}</a>
        <a href="{{site_url('transfer/index/rincian/'.$transfer->id).'?ref='.$ref}}" class="btn btn-primary">02. Rincian Aset</a>
    </div>
    @if($ref==='keluar')
...
<script>
    ...
    @if($transfer->status_pengajuan === '1' OR $transfer->status_pengajuan === '2' OR $ref==='masuk' OR $ref==='persetujuan')
    $('#formulir :input, #formulir button, #formulir select').prop('disabled', true);
    @endif
