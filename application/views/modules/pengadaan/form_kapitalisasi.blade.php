				...
				<form action="{{isset($kpt) ? site_url('pengadaan/kapitalisasi/update') : site_url('pengadaan/kapitalisasi/insert')}}" method="POST">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							...
							<a href="{{site_url('pengadaan/index/rincian/'.$spk->id)}}" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Kembali</a>
						</div>
					</div>
				</form>
			</div>
...
<script type="text/javascript">
	...
	$(".btn-aset").on('click', function(e){
		...
		var url = 'pengadaan/'+kib+'/get?id_organisasi={{$spk->id_organisasi}}&id_kategori='+idKategori;
