...
<div class="card">
	<div class="card-header form-inline">
		<span>KIB-G (Aset Lainnya)</span>
		<form action="{{site_url('aset/kibg')}}" method="GET" class="ml-auto">
	...
	<div class="card-body">
		<table class="jq-table table-striped" data-search="true" data-show-columns="true" data-search-on-enter-key="true" data-pagination="true" data-side-pagination="server" data-url="{{site_url('aset/kibg/get/'.$id_organisasi.'/'.$source)}}">
			<thead>
					<tr>
						@if($source === 'berjalan')
	...
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{site_url('aset/kibg/update')}}" method="POST">
...
<script type="text/javascript">
	var kib = (function(){
		...
		// GET RINCIAN
		$.getJSON("{{site_url('aset/kibg/get_rincian_widget/'.$id_organisasi.'/'.$source)}}", function(result){
