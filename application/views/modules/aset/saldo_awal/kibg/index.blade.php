...
<li class="breadcrumb-item"><a href="{{site_url('saldo_awal/kibg?id_organisasi='.$filter['id_organisasi'])}}">Aset Saldo Awal</a></li>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{site_url('saldo_awal/kibg')}}" method="GET">
