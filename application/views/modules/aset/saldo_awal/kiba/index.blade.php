...
<li class="breadcrumb-item"><a href="{{site_url('saldo_awal/kiba?id_organisasi='.$filter['id_organisasi'])}}">Aset Saldo Awal</a></li>
	...
	<div class="col">
		<div class="card">
			<div class="card-header form-inline">
				<form action="{{site_url('saldo_awal/kiba')}}" method="GET" class="mr-auto">
			...
			<div class="card-body table-responsive table-scroll px-0 py-0">
				<table class="table table-hover table-striped table-bordered">
					...
					<tbody>
						@if(empty($kib))
						<tr><td colspan="13" class="text-center"><b><i>Data kosong</i></b></td></tr>
						@endif
						...
						<tr>
							...
							<td class="text-nowrap">{{monefy($item->luas, FALSE)}}</td>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{site_url('saldo_awal/kiba')}}" method="GET">
...
<script type="text/javascript">
	var kib = (function(){
		...
		// GET RINCIAN
		$.getJSON("{{site_url('saldo_awal/kiba/get_rincian_widget/'.$filter['id_organisasi'])}}", function(result){
