...
<li class="breadcrumb-item"><a href="{{site_url('saldo_awal/kibd?id_organisasi='.$filter['id_organisasi'])}}">Aset Saldo Awal</a></li>
				...
				<table class="table table-hover table-striped table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-nowrap">{{monefy($item->panjang, FALSE)}}</td>
							<td class="text-nowrap">{{monefy($item->lebar, FALSE)}}</td>
...
<script type="text/javascript">
	var kib = (function(){
		...
		// GET RINCIAN
		$.getJSON("{{site_url('saldo_awal/kibd/get_rincian_widget/'.$filter['id_organisasi'])}}", function(result){
