...
<li class="breadcrumb-item"><a href="{{site_url('aset/inventarisasi/kiba')}}">Aset</a></li>
<li class="breadcrumb-item"><a href="{{site_url('aset/inventarisasi/kiba')}}">KIB-A</a></li>
...
<div class="row">
	<div class="col">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{isset($kib)?site_url('aset/inventarisasi/kiba/update'):site_url('aset/inventarisasi/kiba/insert')}}" method="POST">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							<input type="number" class="form-control" name="nilai" value="1000" placeholder="Nilai" value="{{isset($kib)?$kib->nilai:''}}" required/>
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							...
							<a href="{{site_url('aset/inventarisasi/kiba')}}" class="btn btn-warning">Kembali</a>
						</div>
					</div>
				</form>
			</div>
