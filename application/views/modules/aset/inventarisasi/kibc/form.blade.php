...
<li class="breadcrumb-item"><a href="{{site_url('aset/inventarisasi/kibc')}}">Aset</a></li>
...
<div class="row">
	<div class="col">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{isset($kib)?site_url('aset/inventarisasi/kibc/update'):site_url('aset/inventarisasi/kibc/insert')}}" method="POST">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							...
							<a href="{{site_url('aset/inventarisasi/kibc')}}" class="btn btn-warning">Kembali</a>
						</div>
					</div>
				</form>
			</div>
