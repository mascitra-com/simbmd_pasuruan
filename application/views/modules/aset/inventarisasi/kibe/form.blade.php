...
<li class="breadcrumb-item"><a href="{{site_url('aset/inventarisasi/kibe')}}">Aset</a></li>
<li class="breadcrumb-item"><a href="{{site_url('aset/inventarisasi/kibe')}}">KIB-E</a></li>
...
<div class="row">
	<div class="col">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{isset($kib)?site_url('aset/inventarisasi/kibe/update'):site_url('aset/inventarisasi/kibe/insert')}}" method="POST">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							...
							<a href="{{site_url('aset/inventarisasi/kibe')}}" class="btn btn-warning">Kembali</a>
						</div>
					</div>
				</form>
			</div>
