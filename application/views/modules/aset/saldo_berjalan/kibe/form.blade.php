...
<li class="breadcrumb-item"><a href="{{site_url('inventarisasi/kibe')}}">Aset</a></li>
<li class="breadcrumb-item"><a href="{{site_url('inventarisasi/kibe?id_organisasi='.$org->id)}}">KIB-E</a></li>
				...
				<form action="{{isset($kib)?site_url('inventarisasi/kibe/update'):site_url('inventarisasi/kibe/insert')}}" method="POST">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							...
							<a href="{{site_url('inventarisasi/kibe')}}" class="btn btn-warning">Kembali</a>
						</div>
					</div>
				</form>
			</div>
