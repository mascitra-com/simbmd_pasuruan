		...
		<div class="card">
			<div class="card-header form-inline">
				...
				<div class="btn-group">
					...
					<a href="{{site_url('inventarisasi/kibe/add/'.$filter['id_organisasi'])}}" class="btn btn-primary"><i class="fa fa-plus mr-2"></i>Tambah</a>
				</div>
			</div>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{site_url('inventarisasi/kibe')}}" method="GET">
...
<script type="text/javascript">
	var kib = (function(){
		...
		// GET RINCIAN
		$.getJSON("{{site_url('inventarisasi/kibe/get_rincian_widget/'.$filter['id_organisasi'])}}", function(result){
