...
<li class="breadcrumb-item"><a href="{{site_url('inventarisasi/kibnon?id_organisasi='.$org->id)}}">Aset</a></li>
<li class="breadcrumb-item"><a href="{{site_url('inventarisasi/kibnon?id_organisasi='.$org->id)}}">Tidak Diakui Aset</a></li>
...
<div class="row">
	<div class="col">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{isset($kib)?site_url('inventarisasi/kibnon/update'):site_url('inventarisasi/kibnon/insert')}}" method="POST">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							...
							<a href="{{site_url('inventarisasi/kibnon?id_organisasi='.$org->id)}}" class="btn btn-warning">Kembali</a>
						</div>
					</div>
				</form>
			</div>
