	...
	<div class="col">
		<div class="card">
			<div class="card-header form-inline">
				<form action="{{site_url('inventarisasi/kibd/kdp')}}" method="GET" class="mr-auto">
						...
						<tr>
							<td class="text-nowrap text-center">
								<div class="btn-group">
									...
									<a href="{{site_url('inventarisasi/kibd/delete/'.$item->id)}}" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin?')"><i class="fa fa-trash"></i></a>
								</div>
							</td>
							<td class="text-nowrap text-center">
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{site_url('inventarisasi/kibd/kdp')}}" method="GET">
