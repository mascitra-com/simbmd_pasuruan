	...
	<div class="col">
		<div class="card">
			<div class="card-header form-inline">
				<form action="{{site_url('inventarisasi/kibd')}}" method="GET" class="mr-auto">
				...
				<div class="btn-group">
					...
					<a href="{{site_url('inventarisasi/kibd/add/'.$filter['id_organisasi'])}}" class="btn btn-primary"><i class="fa fa-plus mr-2"></i>Tambah</a>
				</div>
			</div>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{site_url('inventarisasi/kibd')}}" method="GET">
...
<script type="text/javascript">
	var kib = (function(){
		...
		// GET RINCIAN
		$.getJSON("{{site_url('inventarisasi/kibd/get_rincian_widget/'.$filter['id_organisasi'])}}", function(result){
