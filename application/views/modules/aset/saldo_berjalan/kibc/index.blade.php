...
<li class="breadcrumb-item active">KIB-C</li>
@end
...
<div class="row mb-4">
	...
	<div class="col">
		<div class="card bg-warning" id="wg-nilai-rusak">
			<div class="card-body">
				<div class="card-title mb-0">NILAI ASET RUSAK</div>
				<div class="card-text font-weight-bold" style="font-size: 1.5em"><div class="fa fa-spinner fa-spin"></div> Mengambil nilai...</div>
			</div>
		</div>
	</div>
	<div class="col">
		<div class="card text-white bg-danger" id="wg-total-rusak">
			<div class="card-body">
				<div class="card-title mb-0">BANYAK ASET RUSAK</div>
				<div class="card-text font-weight-bold" style="font-size: 1.5em"><div class="fa fa-spinner fa-spin"></div> Mengambil nilai...</div>
			</div>
		</div>
	</div>
	...
	<div class="col">
		<div class="card">
			<div class="card-header form-inline">
				<form action="{{site_url('inventarisasi/kibc')}}" method="GET" class="mr-auto">
				...
				<div class="btn-group">
					...
					<a href="{{site_url('inventarisasi/kibc/add/'.$filter['id_organisasi'])}}" class="btn btn-primary"><i class="fa fa-plus mr-2"></i>Tambah</a>
				</div>
			</div>
				...
				<table class="table table-hover table-striped table-bordered">
					<thead>
						<tr>
							...
							<th class="text-nowrap text-right">Kapitalisasi</th>
							<th class="text-nowrap text-right">Nilai Total</th>
						...
						<tr>
							<td class="text-nowrap text-center">
								<div class="btn-group">
									...
									<a href="{{site_url('inventarisasi/kibc/delete/'.$item->id)}}" class="btn btn-danger btn-sm" data-id="{{$item->id}}" onclick="return confirm('Apakah anda yakin?')"><i class="fa fa-trash"></i></a>
									@endif
								</div>
							</td>
							<td class="text-nowrap text-center">
							...
							<td class="text-nowrap text-right">{{monefy($item->nilai_tambah)}}</td>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{site_url('inventarisasi/kibc')}}" method="GET">
...
<script type="text/javascript">
	var kib = (function(){
		...
		// GET RINCIAN
		$.getJSON("{{site_url('inventarisasi/kibc/get_rincian_widget/'.$filter['id_organisasi'])}}", function(result){
