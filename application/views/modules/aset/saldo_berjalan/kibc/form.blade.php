...
<li class="breadcrumb-item"><a href="{{site_url('inventarisasi/kibc')}}">Aset</a></li>
<li class="breadcrumb-item"><a href="{{site_url('inventarisasi/kibc?id_organisasi='.$org->id)}}">KIB-C</a></li>
...
<div class="row">
	<div class="col">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{isset($kib)?site_url('inventarisasi/kibc/update'):site_url('inventarisasi/kibc/insert')}}" method="POST">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							...
							<a href="{{site_url('inventarisasi/kibc')}}" class="btn btn-warning">Kembali</a>
						</div>
					</div>
				</form>
			</div>
							...
							<th colspan="4">
								<div class="input-group">
									<select id="in-pilih" class="form-control">
										<option value="3" selected>03. Gedung &amp Bangunan</option>
