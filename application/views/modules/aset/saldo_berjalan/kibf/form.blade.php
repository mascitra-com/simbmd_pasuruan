...
<li class="breadcrumb-item"><a href="{{site_url('inventarisasi/kibf')}}">Aset</a></li>
<li class="breadcrumb-item"><a href="{{site_url('inventarisasi/kibf')}}">KIB-F</a></li>
...
<div class="row">
	<div class="col">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{isset($kib)?site_url('inventarisasi/kibf/update'):site_url('inventarisasi/kibf/insert')}}" method="POST">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							...
							<a href="{{site_url('inventarisasi/kibf')}}" class="btn btn-warning">Kembali</a>
						</div>
					</div>
				</form>
			</div>
