	...
	<div class="col">
		<div class="card">
			<div class="card-header form-inline">
				<form action="{{site_url('inventarisasi/kibb')}}" method="GET" class="mr-auto">
				...
				<div class="btn-group">
					...
					<a href="{{site_url('inventarisasi/kibb/add/'.$filter['id_organisasi'])}}" class="btn btn-primary"><i class="fa fa-plus mr-2"></i>Tambah</a>
				</div>
			</div>
					...
					<tbody>
						...
						<tr>
							<td class="text-nowrap text-center">
								<div class="btn-group">
									<a href="{{site_url('inventarisasi/kibb/edit/'.$item->id)}}" class="btn btn-sm btn-warning"><i class="fa fa-pencil"></i></a>
									@if($this->session->auth['is_superadmin'] == 1)
									<!-- <a href="{{site_url('inventarisasi/kibb/delete/'.$item->id)}}" class="btn btn-danger btn-sm" data-id="{{$item->id}}" onclick="return confirm('Apakah anda yakin?')"><i class="fa fa-trash"></i></a> -->
									@endif
								</div>
							</td>
							<td class="text-nowrap text-center">
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{site_url('inventarisasi/kibb')}}" method="GET">
...
<script type="text/javascript">
	var kib = (function(){
		...
		// GET RINCIAN
		$.getJSON("{{site_url('inventarisasi/kibb/get_rincian_widget/'.$filter['id_organisasi'])}}", function(result){
