						...
						<tr>
							<td class="text-nowrap text-center">
								<div class="btn-group">
									...
									<a href="{{site_url('inventarisasi/kibg/delete/'.$item->id)}}" class="btn btn-danger btn-sm" data-id="{{$item->id}}" onclick="return confirm('Apakah anda yakin?')"><i class="fa fa-trash"></i></a>
									@endif
								</div>
							</td>
							<td class="text-nowrap text-center">
...
<script type="text/javascript">
	var kib = (function(){
		...
		// GET RINCIAN
		$.getJSON("{{site_url('inventarisasi/kibg/get_rincian_widget/'.$filter['id_organisasi'])}}", function(result){
