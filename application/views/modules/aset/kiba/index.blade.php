...
<div class="card">
	<div class="card-header form-inline">
		<span>KIB-A (Tanah)</span>
		<form action="{{site_url('aset/kiba')}}" method="GET" class="ml-auto">
...
<script type="text/javascript">
	var kib = (function(){
		...
		// GET RINCIAN
		$.getJSON("{{site_url('aset/kiba/get_rincian_widget/'.$id_organisasi.'/'.$source)}}", function(result){
