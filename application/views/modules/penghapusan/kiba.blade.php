                    ...
                    <table class="table table-hover table-striped table-bordered">
						...
						<tr>
							<td class="text-nowrap text-center">
								<div class="btn-group">
									<a href="{{ site_url('aset/kiba/insert_penghapusan?id_aset='.$item->id.'&id='.$hapus->id) }}" class="btn btn-sm btn-success"><i class="fa fa-plus"></i></a>
								</div>
							</td>
							<td class="text-nowrap text-center">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{site_url('aset/kiba/add_transfer/'.$filter['id_organisasi'])}}" method="GET">
