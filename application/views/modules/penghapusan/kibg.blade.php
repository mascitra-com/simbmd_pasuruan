		...
		<div class="card">
			<div class="card-header form-inline">
				<div class="btn-group">
					...
					<button class="btn btn-primary"><i class="fa fa-check mr-2"></i>Terpilih <span class="badge badge-warning" id="terpilih_count">{{ $terpilih_count }}</span></button>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{site_url('aset/kibg/add_penghapusan/'.$hapus->id)}}" method="GET">
...
<script type="text/javascript">
	var kib = (function(){
		...
		function fungsiTambah(e) {
			...
			$.post("{{site_url('penghapusan/kibg/insert')}}",
				data,
				function(result){
