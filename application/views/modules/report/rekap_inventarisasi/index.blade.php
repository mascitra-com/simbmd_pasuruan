...
@section('title')Rekapitulasi Inventarisasi@end

@section('breadcrump')
<li class="breadcrumb-item"><a href="{{site_url()}}">Beranda</a></li>
<li class="breadcrumb-item"><a href="#">Laporan</a></li>
<li class="breadcrumb-item active">Rekapitulasi Inventarisasi</li>
@end
...
<div class="card">
	...
	<div class="card-body">
		<form action="{{site_url('report/rekap_inventarisasi/cetak')}}" method="POST">
