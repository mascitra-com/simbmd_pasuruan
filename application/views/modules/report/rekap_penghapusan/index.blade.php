...
<div class="row">
	<div class="col">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{site_url('report/rekap_penghapusan/cetak')}}" method="POST">
					...
					<div class="form-group row">
						<label class="col-md-3 col-form-label text-right">Periode SK</label>
						<div class="col-md-4">
							<?php $year = date('Y'); ?>
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							<div class="input-group">
								<input type="text" name="lapor_nama" class="form-control form-control-sm" value="{{ $melaporkan_penghapusan->nama }}" placeholder="Nama" />
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							<input type="text" name="lapor_nip" class="form-control form-control-sm" value="{{ $melaporkan_penghapusan->nip }}" placeholder="NIP" />
						</div>
					</div>
					<div class="form-group row">
						<label class="col-md-3 col-form-label text-right">Jabatan</label>
						<div class="col-md-4">
							<input type="text" name="lapor_jabatan" class="form-control form-control-sm" value="{{ $melaporkan_penghapusan->jabatan }}" placeholder="Jabatan" />
						</div>
					</div>
					<hr>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							<div class="input-group">
								<input type="text" name="mengetahui_nama" value="{{ $mengetahui_penghapusan->nama }}" class="form-control form-control-sm" placeholder="Nama" />
								<span class="input-group-btn">
                                <button type="button" class="btn btn-primary" data-toggle="modal"
					...
					<div class="form-group row">
						<label class="col-md-3 col-form-label text-right">NIP</label>
						<div class="col-md-4">
							<input type="text" name="mengetahui_nip" value="{{ $mengetahui_penghapusan->nip }}" class="form-control form-control-sm" placeholder="NIP" />
						</div>
					</div>
					<div class="form-group row">
						<label class="col-md-3 col-form-label text-right">Jabatan</label>
						<div class="col-md-4">
							<input type="text" name="mengetahui_jabatan" value="{{ $mengetahui_penghapusan->jabatan }}" class="form-control form-control-sm" placeholder="Jabatan" />
						</div>
					</div>
					<div class="form-group row">
						<label class="col-md-3 col-form-label text-right"></label>
...
<script type="text/javascript">
    ...
    function fungsiTombolMengetahui(e) {
        $.getJSON("{{site_url('pegawai/save_cookie?name=mengetahui_penghapusan&id=')}}" + $(e.currentTarget).data('id'), function (result) {
    ...
    function fungsiTombolMelaporkan(e) {
        $.getJSON("{{site_url('pegawai/save_cookie?name=melaporkan_penghapusan&id=')}}" + $(e.currentTarget).data('id'), function (result) {
