			...
			<div class="card-body">
				<form action="{{site_url('report/rekap_pengadaan/cetak')}}" method="POST">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							<div class="input-group">
								<input type="text" name="lapor_nama" class="form-control form-control-sm" value="{{ $melaporkan_pengadaan->nama }}" placeholder="Nama" />
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							<input type="text" name="lapor_nip" class="form-control form-control-sm" value="{{ $melaporkan_pengadaan->nip }}" placeholder="NIP" />
						</div>
					</div>
					<div class="form-group row">
						<label class="col-md-3 col-form-label text-right">Jabatan</label>
						<div class="col-md-4">
							<input type="text" name="lapor_jabatan" class="form-control form-control-sm" value="{{ $melaporkan_pengadaan->jabatan }}" placeholder="Jabatan" />
						</div>
					</div>
					<hr>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							<div class="input-group">
								<input type="text" name="mengetahui_nama" value="{{ $mengetahui_pengadaan->nama }}" class="form-control form-control-sm" placeholder="Nama" />
								<span class="input-group-btn">
                                <button type="button" class="btn btn-primary" data-toggle="modal"
					...
					<div class="form-group row">
						<label class="col-md-3 col-form-label text-right">NIP</label>
						<div class="col-md-4">
							<input type="text" name="mengetahui_nip" value="{{ $mengetahui_pengadaan->nip }}" class="form-control form-control-sm" placeholder="NIP" />
						</div>
					</div>
					<div class="form-group row">
						<label class="col-md-3 col-form-label text-right">Jabatan</label>
						<div class="col-md-4">
							<input type="text" name="mengetahui_jabatan" value="{{ $mengetahui_pengadaan->jabatan }}" class="form-control form-control-sm" placeholder="Jabatan" />
						</div>
					</div>
					<div class="form-group row">
						<label class="col-md-3 col-form-label text-right"></label>
...
<script type="text/javascript">
    ...
    function fungsiTombolMengetahui(e) {
        $.getJSON("{{site_url('pegawai/save_cookie?name=mengetahui_pengadaan&id=')}}" + $(e.currentTarget).data('id'), function (result) {
    ...
    function fungsiTombolMelaporkan(e) {
        $.getJSON("{{site_url('pegawai/save_cookie?name=melaporkan_pengadaan&id=')}}" + $(e.currentTarget).data('id'), function (result) {
